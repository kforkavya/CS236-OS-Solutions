...
void            increase_refcount(uint);
int             get_refcount(uint);
void            decrease_refcount(uint);
...
int             check_CoW_bit_set_or_not(struct proc*, uint);
void            make_a_copy_of_physical_frame_at_this_va_and_remove_CoW_bit_and_set_W_bit(struct proc*, uint);

   ...
   1:	b9 02 00 00 00       	mov    $0x2,%ecx
{
  ...
  13:	c7 04 24 58 08 00 00 	movl   $0x858,(%esp)
  1a:	e8 84 03 00 00       	call   3a3 <open>
  1f:	85 c0                	test   %eax,%eax
  21:	0f 88 be 00 00 00    	js     e5 <main+0xe5>
    mknod("console", 1, 1);
    open("console", O_RDWR);
  }
  ...
  47:	ba 60 08 00 00       	mov    $0x860,%edx
  ...
  5c:	89 c3                	mov    %eax,%ebx
    if(pid < 0){
  5e:	78 3f                	js     9f <main+0x9f>
      printf(1, "init: fork failed\n");
      exit();
    }
    if(pid == 0){
  60:	74 56                	je     b8 <main+0xb8>
  ...
  88:	b8 9f 08 00 00       	mov    $0x89f,%eax
  8d:	89 44 24 04          	mov    %eax,0x4(%esp)
  91:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  98:	e8 33 04 00 00       	call   4d0 <printf>
  9d:	eb d1                	jmp    70 <main+0x70>
      printf(1, "init: fork failed\n");
  9f:	c7 44 24 04 73 08 00 	movl   $0x873,0x4(%esp)
  a6:	00 
  a7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  ae:	e8 1d 04 00 00       	call   4d0 <printf>
      exit();
  b3:	e8 ab 02 00 00       	call   363 <exit>
      exec("sh", argv);
  b8:	c7 44 24 04 20 09 00 	movl   $0x920,0x4(%esp)
  bf:	00 
  c0:	c7 04 24 86 08 00 00 	movl   $0x886,(%esp)
  c7:	e8 cf 02 00 00       	call   39b <exec>
      printf(1, "init: exec sh failed\n");
  cc:	c7 44 24 04 89 08 00 	movl   $0x889,0x4(%esp)
  d3:	00 
  ...
  f4:	00 
  f5:	c7 04 24 58 08 00 00 	movl   $0x858,(%esp)
  fc:	e8 aa 02 00 00       	call   3ab <mknod>
    open("console", O_RDWR);
 101:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
 108:	00 
 109:	c7 04 24 58 08 00 00 	movl   $0x858,(%esp)
 110:	e8 8e 02 00 00       	call   3a3 <open>
 115:	e9 0d ff ff ff       	jmp    27 <main+0x27>
 ...
 41b:	89 d1                	mov    %edx,%ecx
{
 ...
 45c:	0f b6 92 0c 09 00 00 	movzbl 0x90c(%edx),%edx
 ...
 4d9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 53d:	ff 24 85 b4 08 00 00 	jmp    *0x8b4(,%eax,4)
 ...
 6b0:	b0 28                	mov    $0x28,%al
          s = "(null)";
 6b2:	b9 ab 08 00 00       	mov    $0x8ab,%ecx
...
free(void *ap)
{
 ...
 6d1:	a1 28 09 00 00       	mov    0x928,%eax
{
 ...
 719:	5b                   	pop    %ebx
  freep = p;
 71a:	89 15 28 09 00 00    	mov    %edx,0x928
}
 720:	5e                   	pop    %esi
 721:	5f                   	pop    %edi
 722:	5d                   	pop    %ebp
 ...
 747:	75 ce                	jne    717 <free+0x47>
  freep = p;
 749:	89 15 28 09 00 00    	mov    %edx,0x928
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 779:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 77c:	8b 15 28 09 00 00    	mov    0x928,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7b7:	73 3f                	jae    7f8 <malloc+0x88>
    ...
    if(p == freep)
 7b9:	39 05 28 09 00 00    	cmp    %eax,0x928
 ...
 7d9:	e8 f2 fe ff ff       	call   6d0 <free>
  return freep;
 7de:	8b 15 28 09 00 00    	mov    0x928,%edx
 ...
 804:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 807:	89 15 28 09 00 00    	mov    %edx,0x928
}
 ...
 81f:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 820:	b8 2c 09 00 00       	mov    $0x92c,%eax
 825:	ba 2c 09 00 00       	mov    $0x92c,%edx
 82a:	a3 28 09 00 00       	mov    %eax,0x928
    base.s.size = 0;
 82f:	31 c9                	xor    %ecx,%ecx
 831:	b8 2c 09 00 00       	mov    $0x92c,%eax
    base.s.ptr = freep = prevp = &base;
 836:	89 15 2c 09 00 00    	mov    %edx,0x92c
    base.s.size = 0;
 83c:	89 0d 30 09 00 00    	mov    %ecx,0x930
    if(p->s.size >= nunits){

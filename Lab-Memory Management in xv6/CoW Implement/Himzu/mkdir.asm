...
main(int argc, char *argv[])
{
  ...
  40:	c7 44 24 04 cf 07 00 	movl   $0x7cf,0x4(%esp)
  47:	00 
 ...
 37b:	89 d1                	mov    %edx,%ecx
{
 ...
 3bc:	0f b6 92 4c 08 00 00 	movzbl 0x84c(%edx),%edx
 ...
 439:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 49d:	ff 24 85 f4 07 00 00 	jmp    *0x7f4(,%eax,4)
 ...
 610:	b0 28                	mov    $0x28,%al
          s = "(null)";
 612:	b9 eb 07 00 00       	mov    $0x7eb,%ecx
...
free(void *ap)
{
 ...
 631:	a1 60 08 00 00       	mov    0x860,%eax
{
 ...
 679:	5b                   	pop    %ebx
  freep = p;
 67a:	89 15 60 08 00 00    	mov    %edx,0x860
}
 680:	5e                   	pop    %esi
 681:	5f                   	pop    %edi
 682:	5d                   	pop    %ebp
 ...
 6a7:	75 ce                	jne    677 <free+0x47>
  freep = p;
 6a9:	89 15 60 08 00 00    	mov    %edx,0x860
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 15 60 08 00 00    	mov    0x860,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 717:	73 3f                	jae    758 <malloc+0x88>
    ...
    if(p == freep)
 719:	39 05 60 08 00 00    	cmp    %eax,0x860
 ...
 739:	e8 f2 fe ff ff       	call   630 <free>
  return freep;
 73e:	8b 15 60 08 00 00    	mov    0x860,%edx
 ...
 764:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 767:	89 15 60 08 00 00    	mov    %edx,0x860
}
 ...
 77f:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 780:	b8 64 08 00 00       	mov    $0x864,%eax
 785:	ba 64 08 00 00       	mov    $0x864,%edx
 78a:	a3 60 08 00 00       	mov    %eax,0x860
    base.s.size = 0;
 78f:	31 c9                	xor    %ecx,%ecx
 791:	b8 64 08 00 00       	mov    $0x864,%eax
    base.s.ptr = freep = prevp = &base;
 796:	89 15 64 08 00 00    	mov    %edx,0x864
    base.s.size = 0;
 79c:	89 0d 68 08 00 00    	mov    %ecx,0x868
    if(p->s.size >= nunits){
